...
var credit_account_1 = require("../../../src/use-cases/credit-account");
var new_account_1 = require("../../../src/use-cases/new-account");
describe('UseCase: Credit Account', function () {
    ...
    var useCaseCreditAccount = new credit_account_1.CreditAccount(inMemoryDatabaseAccount);
    var useCaseNewAccount = new new_account_1.NewAccount(inMemoryDatabaseRepositoryUser, inMemoryDatabaseAccount, hasher);
    it('Deve depositar um valor em uma conta', function () { return __awaiter(void 0, void 0, void 0, function () {
        var account, result;
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0: return [4 /*yield*/, useCaseNewAccount.execute({
                ...
                case 1:
                    account = _a.sent();
                    return [4 /*yield*/, useCaseCreditAccount.execute({ amount: 100, to: account.value.account_id })];
                case 2:
                    result = _a.sent();
